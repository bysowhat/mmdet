...
def nuscenes_data_prep(root_path,
    ...
    nuscenes_converter.create_nuscenes_infos(
        root_path, out_dir, info_prefix, cfg_path, version=version, max_sweeps=max_sweeps)
    ...
    # create_groundtruth_database(dataset_name, root_path, info_prefix, out_dir,
    #                             f'{out_dir}/{info_prefix}_infos_train.pkl')
...
parser.add_argument(
    '--cfg-path',
    type=str,
    default='configs/_base_/datasets/nus-mm.py',
    help='specify the config path of dataset')
